...
public static class ServiceCollectionExtensions
{
	...
	public static IServiceCollection AddViteServices(this IServiceCollection services, Action<ViteOptions>? configure = null, ServiceLifetime optionsLifetime = ServiceLifetime.Singleton)
	{
	...
	/// <param name="optionsLifetime">The lifetime with which to register the Vite Manifest service in the container.</param>
	/// <returns>The service collection</returns>
	public static IServiceCollection AddViteServices<T>(this IServiceCollection services, Action<ViteOptions>? configure = null, ServiceLifetime optionsLifetime = ServiceLifetime.Singleton)
	...
	/// <param name="optionsLifetime">The lifetime with which to register the Vite Manifest service in the container.</param>
	public static IServiceCollection AddViteServices(this IServiceCollection services, ViteOptions options, ServiceLifetime optionsLifetime = ServiceLifetime.Singleton)
	{
	...
	/// <param name="options">The Vite configuration options. If null, the default options will be used.</param>
	/// <param name="optionsLifetime">The lifetime with which to register the Vite Manifest service in the container.</param>
	public static IServiceCollection AddViteServices<T>(this IServiceCollection services, ViteOptions options, ServiceLifetime optionsLifetime)
		where T : class, IViteManifest
	{
	...
	/// <param name="services">The service collection.</param>
	/// <param name="optionsLifetime">The lifetime with which to register the Vite Manifest service in the container.</param>
	public static IServiceCollection AddViteServices<T>(this IServiceCollection services, ServiceLifetime optionsLifetime)
		where T : class, IViteManifest
	{
	...
	private static IServiceCollection ConfigureServices<T>(this IServiceCollection services, ServiceLifetime lifetime)
		where T : class, IViteManifest
	{
